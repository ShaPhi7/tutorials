...
public class CryptoUtils {
	...
	/*
	 * Normally we would generate a key as per above, however we'll use this method
	 * to get the same key repeatedly and ensure that our test methods always run
	 * the same way and are deterministic.
	 */
